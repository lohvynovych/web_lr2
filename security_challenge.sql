...
(2, 'offices(id, city, address, phone, flag)');
...
INSERT INTO `offices` (`id`, `city`, `address`, `phone`, `flag`) VALUES
(1, 'Stockholm', 'Birger Jarlsgatan 7, 4 tr', '+46 8-616 99 40', 'NullByteCTF'),
(2, 'Berlin', 'Friedrichstraße 68', '+49 173 329 6295', '{'),
(3, 'Hamburg', 'Ferdinandstraße 35', '+49 403 07 39 810','5QL_'),
(4, 'Helsinki', 'Arkadiankatu 23 C', '+358 (0)20 7705600', '1NJ3CT10N_'),
(5, 'London', '8 Ganton Street', '+44 7469 214 950', 'I5_'),
(6, 'München', 'Sternstraße 5', '+49 89 885 627 88', '3AZY'),
...
(1, 'admin', 'Welc0meT0Th3Nu11ByT3Ch@113ng3');
